...
/**
 * Refreshes the WTI trailing move on its own.
 *
 * Separate from `refresh-macro` for the reason the China and dairy routes are:
 * that job overruns its 60-second budget against the OECD, and anything
 * sequenced behind it never runs. This is one Yahoo request.
 *
